...
generated quantities {
  ...
  c = fabs(normal_rng(0, 2));                    // centred around no hardiness, could be as high as -20
  d = fabs(normal_rng(25, 10));               // centred around maximum hardiness, 10 sd 
  ehat = fabs(normal_rng(log(34), 0.2));   // centred around roughly mean temperature (plus 30, sd 0.2exp(0.2)
  b = fabs(normal_rng(10, 10));                 // centred around o, not really sure of appropriate prior tbh  
