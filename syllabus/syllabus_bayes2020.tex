...
Feb 6  & Overfitting etc.      &   Ch 5-6 (119-188)\footnotemark[1] & & Cat \& Dan  \\ % 69 pp Skip end of Ch. 6 (last two sections)
...
\end{tabular}
\end{center}
\footnotetext[1]{Chapter 6: You can skip information theory if you want (though it comes up more in the book so you may want to skim it).} 
